    ...
    <div className="bg-gray-950 text-gray-300 py-20 font-bodyFont">
      <div className="max-w-screen-xl w-11/12   mx-auto grid grid-row-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col gap-5">
          {/* <img className="w-32" src={"/Images/payment logos.jpg"} alt="Payment logos" /> */}
          <p>@ Tanvirul Islam </p>
          <Image className="w-56" src={"/Images/payment logos.jpg"} alt="payments logo" width={200} height={200} />
